    ...
    <footer className="bg-pebble-950 text-slate-400 py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="font-display font-bold text-2xl text-white">NEXTHIRAN</span>
                </div>
                <p className="text-sm leading-relaxed max-w-xs mb-6">
                    NEXTHIRAN provides world-class IT solutions. We transform complex challenges into smooth, elegant digital products.
                </p>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
            <p>&copy; {new Date().getFullYear()} NEXTHIRAN. All rights reserved.</p>
