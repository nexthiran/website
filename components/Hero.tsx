...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-9xl mx-auto px-6 sm:px-6 lg:px-2 relative translate-y-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <RevealOnScroll className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              We are NEXTHIRAN. We craft robust websites, innovative mobile apps, and cutting-edge Gen AI solutions that stand the test of time.
            </p>
