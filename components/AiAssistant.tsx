...
const AiAssistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'model',
      text: "Hi! I'm the NEXTHIRAN AI Assistant. Ask me about our services, how we build apps, or just say hello!",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSend = async (e?: React.FormEvent, promptText?: string, predefAnswer?: string) => {
    ...
    // If a predefined answer was provided (suggestion chip), show it immediately and skip API.
    if (predefAnswer) {
    ...
    try {
      ...
      if (!apiKey) {
        ...
        setTimeout(() => {
             const demoResponse: Message = {
                id: (Date.now() + 1).toString(),
                role: 'model',
                text: "I see you're interested! Since this is a demo environment without a live API key, I can tell you that NEXTHIRAN specializes in integrating real AI models like this into your business applications. Contact us to build your own!",
                timestamp: new Date()
              };
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `
          System: You are a helpful, professional, and slightly witty AI assistant for 'NEXTHIRAN'. 
  ...
  const suggestions = [
    {
      ...
      a: "We deliver end-to-end solutions: web development, mobile apps, and Gen AI integrations—design, build, and deploy."
    },
    {
      q: "How much does a website cost?",
      a: "Costs vary by scope: a basic site starts affordably, while custom platforms depend on features. Contact us for a tailored quote."
    },
    {
      q: "Can you build a mobile app?",
      a: "Yes — we build native and cross-platform mobile apps, integrating backend services, analytics, and deployment pipelines."
    },
    {
      q: "Explain your Gen AI solutions",
      a: "We integrate LLMs and smart agents to automate support, generate content, and analyze data while preserving privacy and control."
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <RevealOnScroll delay={200} className="bg-slate-900 rounded-2xl border border-pebble-700 shadow-2xl overflow-hidden flex flex-col h-[600px] transform hover:scale-[1.01] transition-transform duration-300">
            <div className="bg-slate-800 p-4 border-b border-slate-700 flex items-center gap-3">
                ...
                <span className="ml-2 text-sm text-slate-400 font-mono">next-ai-agent.exe</span>
            </div>
            ...
            <div className="p-4 bg-slate-800 border-t border-slate-700">
               ...
               <div className="flex gap-2 overflow-x-auto pb-3 mb-1 no-scrollbar">
                  {suggestions.map((s, i) => (
                    <button 
                      key={i}
                      onClick={() => handleSend(undefined, s.q, s.a)}
                      disabled={isLoading}
               ...
               {/* <form onSubmit={(e) => handleSend(e)} className="relative">
                <input
                  ...
                  placeholder="Ask NEXTHIRAN AI something..."
