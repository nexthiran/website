        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <RevealOnScroll delay={100} className="lg:col-span-1 space-y-4">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 transform hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-slate-500 text-sm mt-1">nexthiran@gmail.com</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 transform hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-slate-500 text-sm mt-1">+91 79044 39851, +91 93611 10910</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 transform hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-slate-500 text-sm mt-1">4/34, 40th St, D type, Sidco Nagar, Villivakkam, Chennai, Tamil Nadu 600049</p>
            </div>
          </RevealOnScroll>
