        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <RevealOnScroll delay={200} className="space-y-6">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                    Just as NEXTHIRAN are shaped by water over time to become smooth and resilient, 
                    <span className="font-bold text-slate-900"> NEXTHIRAN</span> refines complex technologies into smooth, user-friendly experiences.
                </p>
